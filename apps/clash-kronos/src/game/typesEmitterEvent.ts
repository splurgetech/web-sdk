...
import type { EmitterEventHiddenMultGrid } from '../components/HiddenMultGrid.svelte';
import type { EmitterEventKronosBar } from '../components/KronosBar.svelte';
import type { EmitterEventKronosTransform } from '../components/KronosTransform.svelte';
...
export type EmitterEventGame =
	...
	| EmitterEventSound
	| EmitterEventHiddenMultGrid
	| EmitterEventKronosBar
	| EmitterEventKronosTransform
